            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 text-center animate-box">
                        <div class="product">
                            <div class="product-grid" style="background-image:url({{asset("storage/".$product->image)}});">
                                <div class="inner">
                                    <p>
                                        <a href="{{route("show.product",$product->id)}}" class="icon"><i class="icon-shopping-cart"></i></a>
                                        <a href="{{route("show.product",$product->id)}}" class="icon"><i class="icon-eye"></i></a>
                                    </p>
                                </div>
                            </div>
                            <div class="desc">
                                <h3><a href="{{route("show.product",$product->id)}}">{{$product->name}}</a></h3>
                                <span class="price">@if($product->flag == 1) {{$product->base_price}} @else {{$product->discount_price}} @endif $</span>
                            </div>
                        </div>
                    </div>
                        @endforeach
